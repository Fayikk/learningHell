...
const WhatsAppButton = ({ phoneNumber }) => {
  ...
  return (
    <div className="whatsapp-button" onClick={handleWhatsAppClick} title="Bize WhatsApp'tan ulaşın">
      <WhatsAppIcon />
    </div>
  );
};
 ...
 // public string FullName { get; set; }
  ...
  return (
    ...
    <div className="bootcamp-container">
      ...
      {/* Add the WhatsApp Button - Set your phone number here */}
      <WhatsAppButton phoneNumber="+905310149046" />
