...
const LeadCapturePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-7xl w-full space-y-8 flex flex-col lg:flex-row items-center gap-12">
        {/* Sol taraf */}
        <motion.div 
        ...
        >
          ...
          {/* Timer */}
          <div className="mt-8">
            <p className="text-lg text-gray-600 mb-2">Kampanya bitimine kalan süre:</p>
