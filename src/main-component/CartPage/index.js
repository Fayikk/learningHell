                  ...
                  <div className="col-12">
                    <form action="cart">
                      <table className="table-responsive cart-wrap">
                        <thead>
                          <tr>
                            <th className="images images-b">{t("Image")}</th>
                            <th className="product-2">{t("Product Name")}</th>
                            <th className="ptice">{t("Price")}</th>
                            <th className="stock">{t("Total Price")}</th>
                            <th className="remove remove-b">{t("Action")}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {courses &&
                ...
                <div className="row">
                  <div className="col-12">
                    <form action="cart">
                      ...
                      >
                        <span> {t("You Dont Have Any Item")} </span>
                      </h1>
                      <table className="table-responsive cart-wrap">
                        <thead>
                          <tr>
